#ifndef SCHEDULER_NVML_HELPER_H
#define SCHEDULER_NVML_HELPER_H
...
typedef enum {
  ...
  NVML_ENTRY_ENUM(nvmlDeviceGetClockOffsets),
  ...
  NVML_ENTRY_ENUM(nvmlDeviceGetCoolerInfo),
  NVML_ENTRY_ENUM(nvmlDeviceGetCurrentClockFreqs),
  NVML_ENTRY_ENUM(nvmlDeviceGetCurrentClocksEventReasons),
  NVML_ENTRY_ENUM(nvmlDeviceGetDefaultEccMode),
  NVML_ENTRY_ENUM(nvmlDeviceGetDramEncryptionMode),
  NVML_ENTRY_ENUM(nvmlDeviceGetDriverModel_v2),
  NVML_ENTRY_ENUM(nvmlDeviceGetDynamicPstatesInfo),
  NVML_ENTRY_ENUM(nvmlDeviceGetFanControlPolicy_v2),
  NVML_ENTRY_ENUM(nvmlDeviceGetFanSpeedRPM),
  ...
  NVML_ENTRY_ENUM(nvmlDeviceGetMarginTemperature),
  ...
  NVML_ENTRY_ENUM(nvmlDeviceGetNvlinkBwMode),
  NVML_ENTRY_ENUM(nvmlDeviceGetNvlinkSupportedBwModes),
  ...
  NVML_ENTRY_ENUM(nvmlDeviceGetPerformanceModes),
  NVML_ENTRY_ENUM(nvmlDeviceGetPlatformInfo),
  ...
  NVML_ENTRY_ENUM(nvmlDeviceGetTemperatureV),
  ...
  NVML_ENTRY_ENUM(nvmlDevicePowerSmoothingActivatePresetProfile),
  NVML_ENTRY_ENUM(nvmlDevicePowerSmoothingSetState),
  NVML_ENTRY_ENUM(nvmlDevicePowerSmoothingUpdatePresetProfileParam),
  NVML_ENTRY_ENUM(nvmlDeviceSetClockOffsets),
  NVML_ENTRY_ENUM(nvmlDeviceSetConfComputeUnprotectedMemSize),
  NVML_ENTRY_ENUM(nvmlDeviceSetDefaultFanSpeed_v2),
  NVML_ENTRY_ENUM(nvmlDeviceSetDramEncryptionMode),
  ...
  NVML_ENTRY_ENUM(nvmlDeviceSetNvlinkBwMode),
  ...
  NVML_ENTRY_ENUM(nvmlDeviceWorkloadPowerProfileClearRequestedProfiles),
  NVML_ENTRY_ENUM(nvmlDeviceWorkloadPowerProfileGetCurrentProfiles),
  NVML_ENTRY_ENUM(nvmlDeviceWorkloadPowerProfileGetProfilesInfo),
  NVML_ENTRY_ENUM(nvmlDeviceWorkloadPowerProfileSetRequestedProfiles),
  ...
  NVML_ENTRY_ENUM(nvmlSystemGetDriverBranch),
  ...
  NVML_ENTRY_ENUM(nvmlVgpuInstanceGetRuntimeStateSize),
  NVML_ENTRY_ENUM(nvmlVgpuTypeGetBAR1Info),
